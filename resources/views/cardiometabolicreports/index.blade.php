	...
	<div class="container">
		...
		<div class="row report-col">
			<div class="col-lg-10 mt-2">
				<form class="form-inline" method="POST" action="{{ route('cardiometabolic_report.store') }}">
					@csrf
					<div class="card mt-5">
						<div class="card-body">
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="hs_crp" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="24_hr_bp_average">Microalbumin</label>
										<input type="number" class="form-control" name="microalbumin" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="cholesterol_total" placeholder="" step="0.0000000001" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="tanita_metabolic_age">HDL Cholesterol</label>
										<input type="number" class="form-control" name="hdl_cholesterol" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="triglycerides" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="bbt_result">LDL Cholesterol, Calculated</label>
										<input type="number" class="form-control" name="ldl_cholesterol_calculated" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="bbt_result">Chol/HDL-C</label>
										<input type="number" class="form-control" name="chol_hdl_c" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="bbt_result">Non-HDL Cholesterol</label>
										<input type="number" class="form-control" name="non_hdl_cholesterol" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="bbt_result">TG/HDL-C</label>
										<input type="number" class="form-control" name="tg_hdl_hdl_C" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="lipoprotein_fractionation_nmr" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="glucose" placeholder="" step="1" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Insulin:</label>
										<input type="number" class="form-control" name="insulin" placeholder="" step="1" value=""  />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="hba1c" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Estimated Average Glucose:</label>
										<input type="number" class="form-control" name="estimated_average_glucose" placeholder="" step="1" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="vitamin_b12" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Vitamin D, 25-Hydroxy by LC-MS/(2) MS:</label>
										<input type="number" class="form-control" name="lc_ms" placeholder="" step="1" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="omegacheck" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="sleep_ahi">Arachidonic Acid/EPA Ratio</label>
										<input type="number" class="form-control" name="arachidonic_acid_epa_ratio" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
										<div class="form-group mb-3">
											...
											<input type="number" class="form-control" name="epa" placeholder="" step="0.01" value=""  />
										</div>
								</div>
								<div class="col-lg-6">
										<div class="form-group mb-3">
											<label for="sleep_ahi">DPA</label>
											<input type="number" class="form-control" name="dpa" placeholder="" step="0.01" value=""  />
										</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
										<div class="form-group mb-3">
											...
											<input type="number" class="form-control" name="dha" placeholder="" step="0.01" value=""  />
										</div>
								</div>
								<div class="col-lg-6">
										<div class="form-group mb-3">
											<label for="sleep_ahi">Omega-6 total</label>
											<input type="number" class="form-control" name="omega6_total" placeholder="" step="0.01" value=""  />
										</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
										<div class="form-group mb-3">
											...
											<input type="number" class="form-control" name="arachidonic_acid" placeholder="" step="0.01" value=""  />
										</div>
								</div>
								<div class="col-lg-6">
										<div class="form-group mb-3">
											<label for="sleep_ahi">Linoleic Acid</label>
											<input type="number" class="form-control" name="linoleic_acid" placeholder="" step="0.01" value=""  />
										</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row repeatDiv" id="repeatDiv">
								<div class="col-lg-12">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="nt_probnp" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="row repeatDiv" id="repeatDiv">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="creatine_kinase" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Uric Acid:</label>
										<input type="number" class="form-control" name="uric_acid" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="dhea_s" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="row repeatDiv" id="repeatDiv">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="thyroid_stimulating_hormone" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Thyroxine:</label>
										<input type="number" class="form-control" name="thyroxine" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="glucose" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="24_hr_bp_average">Calcium</label>
										<input type="number" class="form-control" name="calcium" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="sodium" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="vo_2_max">Potassium</label>
										<input type="number" class="form-control" name="potassium" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<!-- <div class="col-lg-6">
									<div class="form-group mb-3">
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="chloride" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="pr_interval">CO2 (Carbon Dioxide, Bicarbonate)</label>
										<input type="number" class="form-control" name="co2" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="bun" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="hrv">BUN/Creatinine Ratio</label>
										<input type="number" class="form-control" name="bun_creatinine_ratio" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="protein" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="hrv">Albumin</label>
										<input type="number" class="form-control" name="albumin" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="globulin" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="hrv">Albumin/Globulin Ratio</label>
										<input type="number" class="form-control" name="albumin_globulin_ratio" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="alp" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="hrv">ALT (Alanine Amino Transferase)</label>
										<input type="number" class="form-control" name="alt" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="ast" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="hrv">Bilirubin</label>
										<input type="number" class="form-control" name="bilirubin" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="egfr" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="testosterone" placeholder="" step="0.0000000001" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="tanita_metabolic_age">Testosterone, Free</label>
										<input type="number" class="form-control" name="testosterone_free" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="testosterone_free_pt" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="bbt_result">Testosterone, Bioavailable</label>
										<input type="number" class="form-control" name="testosterone_bioavailable" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="bbt_result">Sex Hormone Binding Globulin</label>
										<input type="number" class="form-control" name="shbg" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="thyroglobulin_antibodies" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Thyroid Peroxidase Ab</label>
										<input type="number" class="form-control" name="thyroid_peroxidase_ab" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="ggt" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="psychomotor_speed">LIPASE</label>
										<input type="number" class="form-control" name="lipase" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="ferritin" placeholder="" step="1" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Iron:</label>
										<input type="number" class="form-control" name="iron" placeholder="" step="1" value=""  />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="tibc" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Transferrin Saturation:</label>
										<input type="number" class="form-control" name="transferrin_saturation" placeholder="" step="1" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="prostatic_specific_ag" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="ana_screen" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="rheuamatoid_factor" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							<hr />
							...
							<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="antigen_antibody" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">EBV VCA AB (IGM):</label>
										<input type="number" class="form-control" name="ab_igm" placeholder="" step="1" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="ab_igg" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">(AMD) EBV EBNA AB (IGG):</label>
										<input type="number" class="form-control" name="ebnaabigg" placeholder="" step="1" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="h_b_core_ab" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">HEPATITIS B SURFACE AG(AMD):</label>
										<input type="number" class="form-control" name="he_b_surface_ag" placeholder="" step="1" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="h_a_igm" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">HEPATITIS C ANTIBODY:</label>
										<input type="number" class="form-control" name="h_c_antibody" placeholder="" step="1" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="index_1" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="labscreen" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="wbc" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">RBC:</label>
										<input type="number" class="form-control" name="rbc" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="hemoglobin" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Hematocrit:</label>
										<input type="number" class="form-control" name="hematocrit" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="mcv" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">MCH:</label>
										<input type="number" class="form-control" name="mch" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="mchc" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Red Cell Distribution Width:</label>
										<input type="number" class="form-control" name="rcdw" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="platelet_count" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Mean Platelet Volume:</label>
										<input type="number" class="form-control" name="mean_platelet_volume" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="neutrophil" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Neutrophil Absolute:</label>
										<input type="number" class="form-control" name="neutrophil_absolute" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="lymphocyte" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Lymphocyte Absolute:</label>
										<input type="number" class="form-control" name="lymphocyte_absolute" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="monocyte" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Monocyte Absolute:</label>
										<input type="number" class="form-control" name="monocyte_absolute" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="eosinophil" placeholder="" step=".01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="cac">Eosinophil Absolute:</label>
										<input type="number" class="form-control" name="eosinophil_absolute" placeholder="" step=".01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="oxldl" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="ana_pattern" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="vo_2_max">ANA TITER</label>
										<input type="number" class="form-control" name="ana_titer" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="dna_antibody" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="vo_2_max">SM/RNP ANTIBODY</label>
										<input type="number" class="form-control" name="sm_rnp_antibody" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="rnp_antibody" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="vo_2_max">SM ANTIBODY</label>
										<input type="number" class="form-control" name="sm_antibody" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="chromatin" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="vo_2_max">SJOGREN'S ANTIBODY (SS-A)</label>
										<input type="number" class="form-control" name="sjogren_antibody_a" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="sjogren_antibody_b" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="vo_2_max">SCL-70 ANTIBODY</label>
										<input type="number" class="form-control" name="scl_antibody" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="jo1_antibody" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="vo_2_max">RIBOSOMAL P ANTIBODY</label>
										<input type="number" class="form-control" name="ribosomal_p_antibody" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="centromere_b_antibody" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="tg_hdl_c" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="vo_2_max">LDL-P</label>
										<input type="number" class="form-control" name="ldl_p" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="small_ldl_p" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="vo_2_max">LDL Size</label>
										<input type="number" class="form-control" name="ldl_size" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="hdl_p" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="vo_2_max">Large HDL-P</label>
										<input type="number" class="form-control" name="large_hdl_p" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="hdl_size" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="vo_2_max">Large VLDL-P</label>
										<input type="number" class="form-control" name="large_vldl_p" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="vldl_size" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="number" class="form-control" name="egfr_non_african_descent" placeholder="" step="0.01" value=""  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group mb-3">
										<label for="vo_2_max">EGFR African Descent</label>
										<input type="number" class="form-control" name="egfr_african_descent" placeholder="" step="0.01" value=""  />
									</div>
								</div>
							</div>
				...
				<div class="accordion" id="accordion_reports">
					@foreach ($cardiometabolicreports AS $report)
									...
									<div class="card mt-3" id="responsive">
										...
										<div class="card-body">
											...
											<table class="table table-bordered">
												...
												<tr><td width="50%">Vitamin D, 25-Hydroxy by LC-MS/(2) MS</td><td>{{ $report->vitamin_d }}</td></tr>
											...
											<table class="table table-bordered">
x`												<tr><td width="50%">Calcium</td><td>{{ $report->calcium }}</td></tr>
