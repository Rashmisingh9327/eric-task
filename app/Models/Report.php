...
class Report extends Model
{
    ...
    protected $fillable = [
		...
		'region', // For BMD //
		'bmd', // For BMD //
		'expected_bmd', // For BMD //
		'equivalent_age', // For BMD //

		'cac', // For Arterial Age //
		'arterial_age', // For Arterial Age //

		'right_hand_est_grip_strength', // For Grip Strength //
		'height', // For Grip Strength //
		'height_unit', // For Grip Strength //
		'weight', // For Grip Strength //
		'weight_unit', // For Grip Strength //
		'equivalent_age_for_grip_strength', // For Grip Strength //

		'fev_1', // For Lung //
		'equivalent_age_for_lung', // For Lung //
		...
		'max_pulse_wave',
		'24_hr_bp_average',
		'24_hr_bp_average_dbp',
		'skin_age',
		'left_breast_thermography',
		'right_breast_thermography',
		'tanita_metabolic_age',
		'bf_percent',
		'vo_2_max',
		'trudiagnostic_truage',
		'sleep_ahi',
